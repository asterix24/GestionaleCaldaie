...
urlpatterns = patterns('',
	...
	url(r'^export/anagrafe/$', 'main.views.export_table', name='expor_table'),
	...
	url(r'^settings/reset/(?P<setting_id>\w+)/$', 'main.user_settings.settings_reset', name='settings_reset'),
