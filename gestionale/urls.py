...
urlpatterns = patterns('',
    ...
    # anagrafe/11/impianto/15/verifiche/add
	url(r'^anagrafe/(\d+)/impianto/(?P<record_id>\d+)/(?P<detail_type>\w+)/add/$', 'main.views.add_record', name='add_record'),
    ...
    url(r'^anagrafe/(?P<record_id>\d+)/(?P<detail_type>\w+)/(?P<sub_record_id>\d+)/add/$', 'main.views.add_record', name='add_record'),
